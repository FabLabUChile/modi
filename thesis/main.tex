...
\emph{Supervisores:} \\
\href{http://www.jamessmith.com}{\supnamea} % Supervisor name - remove the \href bracket to remove the link 
 
\href{http://www.jamessmith.com}{\supnameb} % Supervisor name - remove the \href bracket to remove the link  

\href{http://www.jamessmith.com}{\supnamec} % Supervisor name - remove the \href bracket to remove the link  
\end{flushright}
\end{minipage}\\[3cm]
