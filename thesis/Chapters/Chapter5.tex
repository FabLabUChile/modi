...
Luego de varias iteraciones (ver Figura \ref{fig:Historia})se logró el modelo final, ver Figura \ref{fig:compRender} b, que tiene cuatro piezas hechas en plástico PLA como se puede ver en la Figura \ref{fig:DiagramaVersionFinal}. En la Figura \ref{fig:modi real} hay unas fotos de siete robots MODI versión final y un robot MODI versión anterior.
